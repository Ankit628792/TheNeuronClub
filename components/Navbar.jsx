...
function Navbar() {
    ...
    return (
        <>
           ...
           {router.pathname == '/' && <div className='w-full text-center max_w_3xl grad-rotate cursor-pointer text-white h-10 py-1 grid place-items-center text-sm md:text-base xl:text-lg'>
