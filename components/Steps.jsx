...
function Steps({step}) {
    return (
        <div className={`mx-5 sm:max-w-3xl lg:max-w-5xl md:flex items-center mx-auto p-5 sm:py-10 rounded-lg hover:scale-[1.01] transition-md bg-white sm:gradient-shadow ${step.no%2!==0 && 'flex-row-reverse'}`}>
