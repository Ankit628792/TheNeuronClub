    ...
    return (
        <>
            {isActive && <motion.div initial="initial"
                ...
                exit="out"
                variants={pageZoom}
                transition={pageTransition} className="fixed top-0 left-0 right-0 bottom-0 w-full h-full grid place-items-center blur-white z-50" onClick={() => setIsActive(false)} >
