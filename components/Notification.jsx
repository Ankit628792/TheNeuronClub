...
function Notification({ bids }) {
    ...
    return (
        <>
            ...
            {!isActive && <BellIcon className="w-12 h-12 text-blue-600 gradient-shadow-lg border border-blue-500 rounded-full float-right p-2 m-3 cursor-pointer fixed bg-white bottom-5 right-5 z-40 animate-bounce" onClick={() => setIsActive(true)} />}
