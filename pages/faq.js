...
function faq() {
    const accordionData = [
        {
            title: 'Why The Neuron Club?',
            content: `Human mind is a prediction machine. Consciously and subconsciously - our mind is perenially assigning probabilities to choices. Differences in our opinions is difference in our inherent probabilities. Probo is a platform to harness these differences, benchmark them against truth and learn from the wisdom of the crowds.`
        },
        {
            title: 'Can you explain Probo in few lines?',
            content: `Probo is an information market on all things important to humans. Participants can trade their opinions of a future event. Clashing of opinions produces information that is of great value to the larger populace. Eventually, truth prevails, winner gets to earn while the loser gets to learn.`
        },
        {
            title: 'What service does Probo provide?',
            content: `At its core, Probo is a discovery of truth platform. In addition, Probo offers avenues to learn for the curious, earn for the experts and oodles of harmless fun for everyone!`
        },
        {
            title: 'How is Probo a “discovery of truth” platform?',
            content: `In bazaar parlance, Price is truth. Price determination requires two parties - a buyer and a seller. True price is established only upon actual trade. Much like markets, Probo harnesses the variances in our opinions into trading opportunities. We nudge users to look at facts closely, set a price (probability) for their opinions basis the underlying facts. As facts change, so do people’s opinion and accordingly prices. Price at any moment reflects the collective wisdom from the crowd.`
        },
        {
