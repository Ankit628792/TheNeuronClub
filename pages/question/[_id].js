                                ...
                                <div className="md:min-h-[500px] w-full flex items-center flex-col lg:flex-row p-10 lg:pb-20 justify-between">
                                    ...
                                    <motion.div
                                        ...
                                        <div className="flex flex-wrap-reverse items-center justify-center lg:justify-start">
                                            ...
                                            <button className="select-none inline-flex min-w-[100px] flex-1 items-center justify-end px-5 py-2 text-lg font-medium rounded-3xl cursor-pointer" onClick={() => setIsShare(true)}><span>Share</span> <ShareIcon title="Share this Question" className="w-6 h-6 mx-1 sm:w-7 sm:h-7 text-white cursor-pointer flex-shrink-0" /></button>
                                        </div>
                                    </motion.div>
