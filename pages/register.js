                    ...
                    <div className="flex flex-col items-center w-full justify-center">
                        <form className="max-w-lg p-10">
                            <div className="flex border-b-2 border-gray-700 py-2 my-6">
                                ...
                                <input className="outline-none flex-grow px-2" type="text" placeholder="User Name " />
                            </div>
                            <div className="flex border-b-2 border-gray-700 py-2 my-6">
                                <MailIcon className="h-6" />
                                <input className="outline-none flex-grow px-2" type="text" placeholder="Your Mail Id " />
                            </div>
                            <div className="flex border-b-2 border-gray-700 py-2 my-6">
                            ...
                            <button className="w-full px-6 py-3 text-lg text-white font-semibold rounded-md my-4 gradient-bg">Register</button>
                            <h1 className="text-center">Already have an account ? <a href="/login" className="text-blue-500 font-medium">Login</a></h1>
