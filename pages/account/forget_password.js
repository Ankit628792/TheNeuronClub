                        ...
                        <>
                            ...
                            <div className="max-w-sm my-8 rounded-lg gradient-shadow mx-auto">
                                <form onSubmit={handleSubmit} className="flex">
                                    <input type="text" className="flex-grow max-w-xs p-3 px-4 focus:outline-none focus:border focus:border-blue-400 placeholder-gray-800 font-normal" value={mail} required placeholder="Email Address ..." onChange={(e) => setMail(e.target.value)} />
