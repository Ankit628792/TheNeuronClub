    ...
    return (
        <>
            ...
            <div className="py-20 relative">
                ...
                <h1 className="text-lg mx-auto md:text-xl max-w-6xl px-8 mt-4 mb-8 text-center text-gray-100"> Join TheNeuron.Club platform to run prediction contests amongst your followers and win rewards. Please <a href="/contact" className="text-yellow-300 cursor-pointer">contact us </a>to signup on the platform as an influencer</h1>
                {/* <div className="h-1 w-60 mx-auto my-4 bg-gray-600"></div> */}
                <div className="min-h-screen blur-white relative max-w-max mx-auto rounded-lg">
